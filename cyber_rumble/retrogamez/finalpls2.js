...
var realm_pass = '8f582151e40e34ba07d4895452868154'

var realm_key = CryptoJS.PBKDF2(realm_pass, realm_salt,{keySize: 256 / 32,iterations: 100});
console.log(CryptoJS.AES.decrypt(message,realm_key,{iv:realm_iv,padding: CryptoJS.pad.Pkcs7,mode:CryptoJS.mode.CBC}).toString(CryptoJS.enc.Utf8));
